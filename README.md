...
These are some of the best materials on the topics that I like to read or are of importance concerning the work

## Machine learning

- [Andrew ng CS229](https://www.youtube.com/playlist?list=PLoROMvodv4rMiGQp3WXShtMGgzqpfVfbU)
- [Machine Learning with PyTorch and Scikit-Learn](https://www.amazon.es/Machine-Learning-PyTorch-Scikit-Learn-Desarrollo/dp/8426735738)
- [Grokking Machine Learning](https://www.amazon.de/-/en/dp/B0B97SYT8K)
- [For almost all topics from Machine Learning to Agents](https://www.youtube.com/@krishnaik06)

## Transformers

- [Andrej Karpathy intro video](https://www.youtube.com/watch?v=7xTGNNLPyMI&t=5846s)
